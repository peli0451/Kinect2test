...
\begin{itemize}
	...
	\item Objektorientierung, Modularisierung
...
\item Probleme (Ausschnitt):
	\begin{itemize}
		\item Trackingfehler (Phantome, Skeletttausch und -löschung)
		\item Konfidente Fehler
		\item Jitter (gewöhnliches Rauschen \&~Sonderfälle)
		\item Proportionsfehler (Posenwechsel \&~Neuzuorndung)
		\item Lichtprobleme (Infrarotabsorption, Reflexionen)
		\item Okklusions- und Orientierungsabhängigkeit
	\end{itemize}
